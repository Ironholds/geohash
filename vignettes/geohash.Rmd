...
If you have ideas for other geohash-related features, or run into a bug, the best approach is to either [request/report it](https://github.com/Ironholds/geohash/issues) or [add it](https://github.com/Ironholds/geohash/pulls)!
